		...
		<?php if ($usuarioLogueado): ?>
			<div class="nav-links">
				<a href="/home" class="nav-link" <?= $esActiva('/home') ?>>
					<svg width="20" height="20" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true">
