...
<header class="admin-header">
    ...
    <nav>
        ...
        <a href="/admin/tmdb/buscar">+ Importar TMDB</a>
    </nav>
</header>
<main>
...
<?php if ($contenidoLocal === []): ?>
    <p>Sin contenido. <a href="/admin/contenido/nuevo">Crear manual</a> o <a href="/admin/tmdb/buscar">importar de TMDB</a>.</p>
<?php else: ?>
    <?php foreach ($contenidoLocal as $item): ?>
        ...
        <article>
            ...
            <div>
                ...
                <form method="POST" action="/admin/contenido/eliminar" onsubmit="return confirm('eliminar?');" style="display:inline">
